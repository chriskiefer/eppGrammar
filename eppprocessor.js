...
var grammar = {
    ...
    {"name": "Effects", "symbols": [(lexer.has("functionkeyword") ? {type: "functionkeyword"} : functionkeyword), "_", "Params", "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "Effects"], "postprocess": d => [ Object.assign({}, d[0].text.toString(), { param: d[2]}) ].concat(d[6])},
    {"name": "Effects", "symbols": [(lexer.has("functionkeyword") ? {type: "functionkeyword"} : functionkeyword), "_", "Params"], "postprocess": d => Object.assign({}, d[0].toString(), { param: d[2]})},
